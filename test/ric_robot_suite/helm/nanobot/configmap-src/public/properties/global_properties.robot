...
${GLOBAL_O1MEDIATOR_SERVER_PORT}        {{ include "common.serviceport.o1mediator.http.mediation" . }}
...
${GLOBAL_SUBMGR_HTTP_PORT}            {{ .Values.ric.platform.components.submgr.port  }}
{{- end }}
#
...
${GLOBAL_TOTAL_NODEB}                 {{ .Values.ric.robot.environment.gNodeB.total_gNodeB }}
#
${GLOBAL_TEST_E2T_ADDRESS}            {{ .Values.ric.robot.environment.E2Term.address }}
#
