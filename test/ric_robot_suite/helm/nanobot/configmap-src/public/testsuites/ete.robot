...
*** Test Cases ***
#Convert to string
#    ${input}        Set Variable            [{"ClientEndpoint":["service-ricxapp-bouncer-xapp-rmr.ricxapp:4560"],"Meid":"gnb_330_2120_b5c67788","SubscriptionId":1,"SubscriptionInstances":null},{"ClientEndpoint":["service-ricxapp-bouncer-xapp-rmr.ricxapp:4560"],"Meid":"gnb_130_2120_b5c67788","SubscriptionId":2,"SubscriptionInstances":null},{"ClientEndpoint":["service-ricxapp-bouncer-xapp-rmr.ricxapp:4560"],"Meid":"gnb_230_2120_b5c67788","SubscriptionId":3,"SubscriptionInstances":null}]
#    ${list_count}       Create List         0
#    ${list_gnb}          Get Regexp Matches        ${input}      (gnb.\\w+)          1
#    ${count}        Get Length      ${list_gnb}
#    Log             ${count}
